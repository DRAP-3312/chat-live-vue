    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g>
          <path
            style="fill: #ffffff"
            d="M400.2,317H104.8c-1.7,0-3.1-1.4-3.1-3.1v-196c0-1.7,1.4-3.1,3.1-3.1h295.3c1.7,0,3.1,1.4,3.1,3.1 v195.9C403.2,315.6,401.9,317,400.2,317z"
          ></path>
          <polygon
            style="fill: #ffffff"
            points="352.4,310.9 287.5,310.9 352.4,410.3 "
          ></polygon>
        </g>
        <g>
          <circle style="fill: #324a5e" cx="334.3" cy="215.9" r="22.1"></circle>
          <circle style="fill: #324a5e" cx="252.5" cy="215.9" r="22.1"></circle>
          <circle style="fill: #324a5e" cx="170.7" cy="215.9" r="22.1"></circle>
        </g>
      </g>
    </svg>
  </div>
  ...
  <div v-else-if="type == 'helloSpan'">
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g id="hand-group" class="animated-hand">
          <g fill="#ffdd67">
            <path
              d="M10 18c-2 .9-2.7 3.3-1.8 5.3l12.6 26.3l7-3.3l-12.6-26.4c-.9-2-3.2-2.9-5.2-1.9"
            ></path>
